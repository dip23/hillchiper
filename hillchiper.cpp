/*
	Nama    : Difa Bagasputra Maulana, Hanif Dwi Prasetyo
	NPM     : 140810180057, 140810180035
	Kelas   : A
...
int main(){
	...
	do{
		...
		cout << "\nMenu : " <<endl;
		cout << "1. Enkripsi\t 2. Dekripsi" <<endl;
		cout << "3. Edit Key\t 4. Cari Key" <<endl;
        cout << "=============================\n";
		cout << "5. Exit" <<endl;
        cout << "=============================\n";
